    ...
    <MainLayout>
      <ProfileIndexLayout>
          ...
          <div className="flex justify-between">
            ...
            <div className="flex justify-between items-center gap-3">
              ...
              <div className="flex justify-end">
                <div ref={filterNode} className="relative flex flex-col">
                  <button
                  ...
                  {dropdownFilterOpen && (
                    <ul className="z-20 absolute top-8 w-[110px] bg-[#23232d] text-[#fff] text-display-5 border border-[#3e3e42]">
              ...
              <div className="flex justify-end">
                <div ref={sortNode} className="relative flex flex-col">
                  <button
                    className="bg-[#121216] text-[#fff] text-display-4 font-bold rounded-full border border-[#3e3e42] px-4 py-1 flex items-center gap-2 hover:bg-[#353539] transition duration-250"
        ...
        <div className="flex flex-wrap justify-between gap-7 px-6">
          <div className="flex flex-col items-start gap-1 min-w-[165px] xl:w-[25%] max-w-[265px]">
            <div className="relative bg-[#42424C] rounded-md w-full cursor-pointer">
              <Image
                src={defaultArtwork}
                placeholder="blur"
                alt="Artist image"
          ...
          {array.map((item) => {
            return (
              <ListItem key={item} type="playlistPage" name="Playlist Name" />
            );
          })}
        </div>
      </ProfileIndexLayout>

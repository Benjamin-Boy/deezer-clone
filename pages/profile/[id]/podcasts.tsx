...
import { BsBroadcastPin, BsBroadcast } from "react-icons/bs";
        ...
        <div className="flex flex-wrap gap-7 px-6">
          <div className="flex flex-col items-start gap-1 min-w-[165px] xl:w-[25%] max-w-[265px]">
            <div className="relative bg-[#42424C] rounded-md w-full cursor-pointer">
              ...
              />
              <div className="text-[7rem] text-[#ef5466] absolute top-2/4 left-2/4 translate-x-[-50%] translate-y-[-50%]">
                <BsBroadcastPin />
              </div>
            </div>
          ...
          {array.map((item) => {
            return <ListItem key={item} type="podcast" name="Podcast Name" />;
          })}
        </div>
      </ProfileIndexLayout>
    </MainLayout>
